...
public class Personal extends Quest{
	...
	@Builder
	public Personal(String type, String title, String description, Date startAt, Date finishAt, String picture, String certification, long mileage, int minArticleCount) {
